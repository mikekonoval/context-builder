...
- **Out-of-band files** — файлы в той же папке, но НЕ в каноническом списке стейджа (например, пользователь добавил `company/marketing-strategy.md`). Сохраняй такие нетронутыми, упомяни в plan как «не часть стейджа, оставляю как есть».
